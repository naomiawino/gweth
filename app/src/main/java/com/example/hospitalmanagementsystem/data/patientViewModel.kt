...
class PatientViewModel:ViewModel() {
    val cloudinaryUrl = "https://api.cloudinary.com/v1_1/dfd6hwrqt/image/upload"
    ...
    private val _patient = mutableStateListOf<patientModel>()
    val patient: List<patientModel>
        get() = _patient
